...
| #                                                               | Decision                                                                 | Status                                                                                  |
| --------------------------------------------------------------- | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- |
| [0001](0001-tech-stack-angular-fastapi-postgres.md)             | Tech stack: Angular + FastAPI + PostgreSQL 18                            | **Accepted** (superseded in part by [0032](0032-migrate-the-frontend-to-react.md))      |
...
| [0016](0016-engagement-state-changes.md)                        | Engagement state changes: REST resource, server-owned                    | **Accepted** (superseded in part by [0034](0034-one-engagement-write.md))               |
| [0017](0017-orm-property-accessors.md)                          | ORM relationship traversal: property accessors on models                 | **Accepted**                                                                            |
| [0018](0018-e2e-testing-database-strategy.md)                   | End-to-end testing database strategy                                     | Superseded by [0030](0030-e2e-runs-against-the-compose-dev-stack.md)                    |
...
| [0026](0026-generated-frontend-api-client-orval.md)             | Frontend API client generated from OpenAPI (orval), synced automatically | **Accepted**                                                                            |
| [0027](0027-database-provisioning-by-lifetime.md)               | Database provisioning split by lifetime; connection URLs derived         | **Accepted**                                                                            |
| [0028](0028-development-happens-in-a-container.md)              | Development happens in a container                                       | **Accepted**                                                                            |
| [0029](0029-single-origin-via-a-reverse-proxy.md)               | The dev stack is served on one origin by a reverse proxy                 | **Accepted**                                                                            |
| [0030](0030-e2e-runs-against-the-compose-dev-stack.md)          | E2E runs against the compose dev stack                                   | **Accepted**                                                                            |
| [0031](0031-confirmations-use-one-adaptive-service.md)          | Confirmations use one service that picks sheet-vs-dialog                 | **Accepted**                                                                            |
| [0032](0032-migrate-the-frontend-to-react.md)                   | Migrate the frontend from Angular to React                               | **Accepted**                                                                            |
| [0033](0033-frontend-layering-and-import-direction.md)          | Frontend layering and import direction                                   | **Accepted**                                                                            |
| [0034](0034-one-engagement-write.md)                            | One engagement write: create, transition and bind in a single POST       | **Accepted**                                                                            |
