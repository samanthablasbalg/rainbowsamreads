 ...
 */
export const engagementsListBookEngagements = (
  bookId: string,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal
) => {
...
export const getEngagementsListBookEngagementsQueryKey = (bookId: string) => {
  return [`/api/books/${bookId}/engagements`] as const;
};

export const getEngagementsListBookEngagementsQueryOptions = <
  TData = Awaited<ReturnType<typeof engagementsListBookEngagements>>,
  TError = ErrorType<HTTPValidationError>,
>(
  bookId: string,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof engagementsListBookEngagements>>, TError, TData>
    >;
    request?: SecondParameter<typeof customInstance>;
  }
) => {
  ...
  const queryKey = queryOptions?.queryKey ?? getEngagementsListBookEngagementsQueryKey(bookId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof engagementsListBookEngagements>>> = ({
    signal,
  }) => engagementsListBookEngagements(bookId, requestOptions, signal);
  ...
  return {
    ...
    Awaited<ReturnType<typeof engagementsListBookEngagements>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type EngagementsListBookEngagementsQueryResult = NonNullable<
  Awaited<ReturnType<typeof engagementsListBookEngagements>>
>;
export type EngagementsListBookEngagementsQueryError = ErrorType<HTTPValidationError>;

export function useEngagementsListBookEngagements<
  TData = Awaited<ReturnType<typeof engagementsListBookEngagements>>,
  TError = ErrorType<HTTPValidationError>,
>(
  bookId: string,
...
>(
  ...
  const queryOptions = getEngagementsListBookEngagementsQueryOptions(bookId, options);
...
export const getEngagementsListBookEngagementsSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof engagementsListBookEngagements>>,
  TError = ErrorType<HTTPValidationError>,
>(
  bookId: string,
...
export type EngagementsListBookEngagementsSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof engagementsListBookEngagements>>
>;
export type EngagementsListBookEngagementsSuspenseQueryError = ErrorType<HTTPValidationError>;

export function useEngagementsListBookEngagementsSuspense<
  TData = Awaited<ReturnType<typeof engagementsListBookEngagements>>,
  TError = ErrorType<HTTPValidationError>,
>(
  bookId: string,
...
>(
  ...
  const queryOptions = getEngagementsListBookEngagementsSuspenseQueryOptions(bookId, options);
