...
describe('the route tree', () => {
  ...
  // The reason react-error-boundary is a dependency: Try again clears the cached failure
  // and re-renders the subtree, so the shelf comes back without the page reloading.
